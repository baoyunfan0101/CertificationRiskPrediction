...
[异常风险账户识别](https://github.com/baoyunfan0101/AbnormalAccountsRecognition)
...
项目来自[系统认证风险预测](https://www.datafountain.cn/competitions/537)竞赛赛题。
...
其中，h(x)的取值范围为[0,1]，可以表示题目所需的账户风险`risk_label`的预测值。又h(x)≥0.5时令y=1，h(x)<0.5时令y=0，即可实现二分类。
